...
var HTTPValidationError = /** @class */ (function (_super) {
    __extends(HTTPValidationError, _super);
    function HTTPValidationError(err) {
        ...
        _this.name = "HTTPValidationError";
        Object.setPrototypeOf(_this, HTTPValidationError.prototype);
        return _this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ValidationError }),
        (0, class_transformer_1.Expose)({ name: "detail" }),
        (0, class_transformer_1.Type)(function () { return shared.ValidationError; }),
        __metadata("design:type", Array)
    ], HTTPValidationError.prototype, "detail", void 0);
