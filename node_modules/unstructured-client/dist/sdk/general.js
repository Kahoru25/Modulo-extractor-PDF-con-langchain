...
var General = /** @class */ (function () {
    function General(sdkConfig) {
        this.sdkConfiguration = sdkConfig;
    }
    /**
     * Pipeline 1
     */
    General.prototype.partition = function (req, retries, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var baseURL, operationUrl, _c, reqBodyHeaders, reqBody, client, globalSecurity, properties, headers, globalRetryConfig, retryConfig, httpRes, responseContentType, res, decodedRes, err;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        operationUrl = baseURL.replace(/\/$/, "") + "/general/v0/general";
                        _c = __read([{}, null], 2), reqBodyHeaders = _c[0], reqBody = _c[1];
                        try {
                            _d = __read(utils.serializeRequestBody(req, "request", "multipart"), 2), reqBodyHeaders = _d[0], reqBody = _d[1];
                        }
                        catch (e) {
                    ...
                    case 2:
                        ...
                        if (!retryConfig) {
                            if (globalRetryConfig) {
                                ...
                                retryConfig = new utils.RetryConfig("backoff", new utils.BackoffStrategy(500, 60000, 1.5, 900000), true);
                            }
                        }
                    ...
                    case 3:
                        ...
                        res = new operations.PartitionResponse({
                        ...
                        switch (true) {
                            ...
                            case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 422:
                                if (utils.matchContentType(responseContentType, "application/json")) {
                                    err = utils.objectToClass(JSON.parse(decodedRes), errors.HTTPValidationError);
